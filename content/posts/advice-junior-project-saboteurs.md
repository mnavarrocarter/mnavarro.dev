...
Developers are not that way, they are nicer. If you push them enough to make an estimation, they will give it to you. There don't have that "professional" sort of attitude in them. Maybe is because some of them didn't even go to uni anyways. 

It does not matter if you have a clear idea or not, they will give you their gut feeling eventually. If they resist, emphasize that you are demanding something really simple. "Look, I don't want you to build it, I just want to know roughly how long. Is that too hard?". Then, once you have your estimation, you can hold them accountable to it. It was their word, so they have to keep it.
...
Convince them that design is for designers, and they are just developers.
...
Here is the trick really. Under no circumstances developers and stakeholders should be ever in the same meeting or in close communication. It is too dangerous, as understanding between the two groups could develop and that could make the project a success.
...
This is very related to the previous tactic, but deserves a topic of it's own. You must make your developers believe they are *doing* Agile and not *being* agile. You see, agile is an adjective, not a substantive. They must never know that.
...
You want them to eat and breathe the commercial Agile, that thing some companies branded and sold as a methodology for project management. They must never know that agile is not a methodology, but a set of values and principles for software development. If they discover the principles, they will want to apply them, and that could be the success of your project. Don't let that happen! 
...
When specifying the work to be done, don't say *why* or *how*. No no, that gives the developer a margin to think. Just say *what* needs to be done and in the most vague way possible. "The client wants this" followed by screenshots of other systems is a great way to waste precious development time for guessing what it needs to be done. 
